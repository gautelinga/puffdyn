...
#
if [ $3 == "0" ]; then
    ./puff L=$2 dt=10 D=0.02 T=1e7 stat_intv=1000 Re=$1 tome_mod=true results_folder=results_tome/L$2_Re$1 init_mode=pair
elif [ $3 == "1" ]; then
    ./puff L=$2 dt=10 D=0.02 T=9e7 stat_intv=10000 Re=$1 tome_mod=true results_folder=results_tome/L$2_Re$1_1 init_mode=fromFile importFile=results_tome/L$2_Re$1/puffsPosition_final.dat
elif [ $3 == "2" ]; then
    ./puff L=$2 dt=10 D=0.02 T=9e8 stat_intv=100000 Re=$1 tome_mod=true results_folder=results_tome/L$2_Re$1_2 init_mode=fromFile importFile=results_tome/L$2_Re$1_1/puffsPosition_final.dat
elif [ $3 == "3" ]; then
